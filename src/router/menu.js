...
const dianhanList_mysql = () => import('@/views/dianhan/jilu/Index.vue')
...
const GylcList = () => import('@/views/superVIp/gylc_list/Index.vue')
...
const Total_beizhu_12 = () => import('@/views/people_luRu/Comment1/Index.vue')
...
export const menu = [
...

    {
        ...
        children: [
...

            {
                path: 'Total_beizhu12',
                name: 'Total_beizhu12',
                component: Total_beizhu_12, // 这里是空压机 蒸发三 四的备注录入
                meta: {
                    title: "蒸发一、二录入",
                },
            },

            {
                path: 'Total_beizhu',
                name: 'Total_beizhu',
                component: Total_beizhu, // 这里是空压机 蒸发三 四的备注录入
                meta: {
                    title: "蒸三、四、空压机",
                },
            },
    ...
    {
        path: '/Total_total_biao_list', //路由跳转路径
        name: 'Total_total_biao_list', //路由名称
        component: Total_total_biao_list, //路由跳转组件 
        meta: {
            title: "录入", // 满足张巨婴，把录入从备注录入摘出来，且只给他看到 录入跟查询，其他不给他看
        },
    ...
    {
        path: '/TotalSummary1', //路由跳转路径
        name: 'TotalSummary1', //路由名称
        component: TotalSummary1, //路由跳转组件 
        meta: {
            title: "查询",
        },
    ...
    {
        path: '/TotalSummary2', //路由跳转路径
        name: 'TotalSummary2', //路由名称
        component: TotalSummary2, //路由跳转组件 
        meta: {
            title: "干燥二",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary3', //路由跳转路径
        name: 'TotalSummary3', //路由名称
        component: TotalSummary3, //路由跳转组件 
        meta: {
            title: "蒸发一",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary4', //路由跳转路径
        name: 'TotalSummary4', //路由名称
        component: TotalSummary4, //路由跳转组件 
        meta: {
            title: "蒸发二",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary5', //路由跳转路径
        name: 'TotalSummary5', //路由名称
        component: TotalSummary5, //路由跳转组件 
        meta: {
            title: "蒸发三",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary6', //路由跳转路径
        name: 'TotalSummary6', //路由名称
        component: TotalSummary6, //路由跳转组件 
        meta: {
            title: "蒸发四",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary7', //路由跳转路径
        name: 'TotalSummary7', //路由名称
        component: TotalSummary7, //路由跳转组件 
        meta: {
            title: "空压机",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary8', //路由跳转路径
        name: 'TotalSummary8', //路由名称
        component: TotalSummary8, //路由跳转组件 
        meta: {
            title: "产量情况统计表",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary9', //路由跳转路径
        name: 'TotalSummary9', //路由名称
        component: TotalSummary9, //路由跳转组件 
        meta: {
            title: "主控电话通知",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary10', //路由跳转路径
        name: 'TotalSummary10', //路由名称
        component: TotalSummary10, //路由跳转组件 
        meta: {
            title: "碘酸钾消耗记录",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary11', //路由跳转路径
        name: 'TotalSummary11', //路由名称
        component: TotalSummary11, //路由跳转组件 
        meta: {
            title: "碘酸钾岗位记录",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary12', //路由跳转路径
        name: 'TotalSummary12', //路由名称
        component: TotalSummary12, //路由跳转组件 
        meta: {
            title: "亚铁氰化钾消耗记录",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary13', //路由跳转路径
        name: 'TotalSummary13', //路由名称
        component: TotalSummary13, //路由跳转组件 
        meta: {
            title: "亚铁氰化钾岗位记录",
            hidden: true 
        },
    ...
    {
        path: '/TotalSummary14', //路由跳转路径
        name: 'TotalSummary14', //路由名称
        component: TotalSummary14, //路由跳转组件 
        meta: {
            title: "成品送库单",
            hidden: true 
        },
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'dianhanList_mysql',
                name: 'dianhanList_mysql',
                component: dianhanList_mysql, // 这里前面大写
                meta: {
                    title: "历史记录",
                    hidden: true 
                },
