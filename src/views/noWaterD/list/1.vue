    ...
    <div>
        ...
        <div>
            <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px; margin-bottom: 5px;margin-left: 8px; color: black; font-size: 18px; font-weight: bold;">
                <el-breadcrumb-item>蒸发四数据管理</el-breadcrumb-item>
                <el-breadcrumb-item>蒸发四数据编辑</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="header">
            <div class="form">
        ...
        <el-table ref="multipleTable" border stripe :data="tableData" height="700" tooltip-effect="dark" @selection-change="selsChange" style="width: 100%; margin-top: 30px" class="custom-table">
            ...
            <el-table-column prop="AcurrentA" label="精卤泵P-200 A电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.AcurrentA" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
    
            <el-table-column prop="ApressureA" label="精卤泵P-200 A压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.ApressureA" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="AcurrentB" label="精卤泵P-200 B电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.AcurrentB" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="ApressureB" label="精卤泵P-200 B压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.ApressureB" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="BcurrentA" label="冷却水泵A电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.BcurrentA" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="BpressureA" label="冷却水泵A压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.BpressureA" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="BcurrentB" label="冷却水泵B电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.BcurrentB" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="BpressureB" label="冷却水泵B压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.BpressureB" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="BcurrentC" label="冷却水泵C电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.BcurrentC" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="BpressureC" label="冷却水泵C压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.BpressureC" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="CcurrentA" label="盐甩后液泵P-403 A电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.CcurrentA" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="CpressureA" label="盐甩后液泵P-403 A压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.CpressureA" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="CcurrentB" label="盐甩后液泵P-403 B电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.CcurrentB" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="CpressureB" label="盐甩后液泵P-403 B压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.CpressureB" class="input" @blur="blurEvent(scope.row,scope.$index)" :disabled="!canEdit(scope.row.inputTime)"></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="DcurrentA" label="回水泵A电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.DcurrentA" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="DpressureA" label="回水泵A压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.DpressureA" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="DcurrentB" label="回水泵B电流（A）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.DcurrentB" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="DpressureB" label="回水泵B压力（Mpa）" width="200">
                <template slot-scope="scope">
                    <el-input type="number" v-model="scope.row.DpressureB" class="input" @blur="blurEvent(scope.row,scope.$index)" readonly></el-input>
                </template>
            </el-table-column>
            ...
            async Submit() {
                ...
                const updatePromises = this.currentIndex.map(index => {
                    ...
                    return this.updatenoWatterD({
                        ...
                        DpressureA: item.DpressureA,
                        DcurrentB: item.DcurrentB,
                        DpressureB: item.DpressureB,
