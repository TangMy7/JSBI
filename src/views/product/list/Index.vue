    ...
    <el-table ref="multipleTable" border stripe :data="tableData" height="658" size="mini" fit="false" tooltip-effect="dark" @selection-change="selsChange"  style="width: 100%; margin-top: 10px" class="custom-table" >
        ...
        <el-table-column  label="CF-401—P-80离心机" min-width="50px" >
            ...
            <el-table-column prop="centrifugeOilPumpCurrentA" label="油泵电机工作电流(A)" min-width="50px" >
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.centrifugeOilPumpCurrentA"  class="input" @blur="blurEvent(scope.row, scope.$index)"  ></el-input>
                </template>
            </el-table-column>
    
            <el-table-column prop="centrifugeMainCurrentA" label="主机电机工作电流(A)" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.centrifugeMainCurrentA" class="input" @blur="blurEvent(scope.row,scope.$index)"  ></el-input>
                </template>
            </el-table-column>
        ...
        <el-table-column  label="CF-402—P-85离心机" min-width="50px">
            ...
            <el-table-column prop="centrifugeOilPumpCurrentB" label="油泵电机工作电流(A)" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.centrifugeOilPumpCurrentB" class="input" @blur="blurEvent(scope.row,scope.$index)"  ></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="centrifugeMainCurrentB" label="主机电机工作电流(A)" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.centrifugeMainCurrentB" class="input" @blur="blurEvent(scope.row,scope.$index)"  ></el-input>
                </template>
            </el-table-column>
        ...
        <el-table-column label="CF-403—P-85离心机" min-width="50px">
            ...
            <el-table-column prop="centrifugeOilPumpCurrentC" label="油泵电机工作电流(A)" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.centrifugeOilPumpCurrentC" class="input" @blur="blurEvent(scope.row,scope.$index)"  ></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="centrifugeMainCurrentC" label="主机电机工作电流(A)" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.centrifugeMainCurrentC" class="input" @blur="blurEvent(scope.row,scope.$index)"  ></el-input>
                </template>
            </el-table-column>
