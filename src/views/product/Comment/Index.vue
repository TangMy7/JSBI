<template>
    <div>
        ...
        <div>
            <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px; margin-bottom: 5px;margin-left: 8px; color: black; font-size: 15px; font-weight: bold;">
                ...
                <el-breadcrumb-item>干燥一备注录入</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="header">
            <div class="form">
    ...
    export default {
        ...
        methods: {
            ...
            async getCommentList(start, end) {
            ...
            deleteRow(index, rows) {
                ...
                this.$confirm('此操作将永久删除该信息, 是否继续?', '提示', {
                    ...
                    this.getCommentList(this.start, this.end);
                });
            },
            ...
            async Submit() {
                ...
                // 刷新数据列表  
                this.getCommentList(this.start, this.end);
                this.getCommentList(this.start, this.end) //刷选两遍，也就相当于重新获取调用函数两次，就出现了，可能是前后端传输的延迟
