...
<div class="main">
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px; margin-bottom: 5px;margin-left: 1px; color: black; font-size: 15px; font-weight: bold;">
            ...
            <el-breadcrumb-item>干燥一备注添加</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    <h1>添加干燥(一)备注数据</h1>
    <el-form :model="formInline" :inline="true" class="demo-form-inline">
        ...
        <el-row :gutter="20">
            ...
            <el-col :span="6">
                <div class="grid-content bg-purple">
                    <el-form-item label="交班人">
                        <el-select v-model="formInline.handoverPerson" multiple placeholder="请选择">
            ...
            <el-col :span="6">
                <div class="grid-content bg-purple">
                    <el-form-item label="接班人">
                        <el-select v-model="formInline.successor" multiple placeholder="请选择">
                            <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
            ...
            <el-col :span="6">
                <div class="grid-content bg-purple">
                    <el-form-item label="松散剂消耗总量">
                        <el-input v-model="formInline.looseAgentConsumptionTotal" type="number"></el-input>
                    </el-form-item>
                </div>
            </el-col>
            ...
            <el-col :span="6">
                <div class="grid-content bg-purple">
                    <el-form-item label="交接工具">
                        <el-select v-model="formInline.handoverTool" placeholder="请选择">
            ...
            <el-col :span="6">
                <div class="grid-content bg-purple">
                    <el-form-item label="设备卫生">
                        <el-select v-model="formInline.deviceHealth" placeholder="请选择">
            ...
            <el-col :span="6">
                <div class="grid-content bg-purple">
                    <el-form-item label="环境卫生">
                        <el-select v-model="formInline.environmentHealth" placeholder="请选择">
                            <el-option v-for="item in options3" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
...
export default {
    ...
    created() {
        this.fetchOptions();
        // this.formInline = this.comment 这个注释掉也没其他变化（这个不注释掉的话，下面给formInline的默认值都没用了）
    ...
    mounted() {
        // 这里可以通过 console.log 检查数据
        console.log('formInline.environmentHealth:', this.formInline.environmentHealth);
    ...
    methods: {
        ...
        onSubmit() {
            ...
            if (this.mode == "edit") {
                ...
                this.addComment({
                    id: this.formInline.id,
                    inputTime: dayjs(this.inputTimeDisplay).add(1, 'hour').format("YYYY-MM-DD HH:mm:ss"),
                    subTime: dayjs(new Date()).format("YYYY-MM-DD HH:mm:ss"),
                    handoverTool: this.formInline.handoverTool,
                    deviceHealth: this.formInline.deviceHealth,
                    environmentHealth: this.formInline.environmentHealth,
        ...
        async addComment(params) {
            ...
            try {
                let res = await this.$api.addCommentItem(params);
