...
<div>
    ...
    <!-- <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 12px; margin-bottom: -5px;margin-left: 18px; color: black; font-size: 15px; font-weight: bold;">
            ...
            <el-breadcrumb-item>主控通知数据汇总</el-breadcrumb-item>
        </el-breadcrumb>
    </div> -->
    <div class="form">
...
export default {
    created() {
        //！！！这个不改是因为，数据库里2024-09-30 00：00：00，小时后面这些被隐藏了，
    ...
    data() {
        return {
            baseUrl: 'http://172.32.12.100:9070/runqian5/reportJsp/showReport.jsp?rpx=/111/iphonemain.rpx&',
            iframeUrl: "",
            start: "",
            end: "",
            date: "",
