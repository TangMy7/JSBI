...
<div>
    ...
    <!-- <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 12px; margin-bottom: -5px;margin-left: 18px; color: black; font-size: 15px; font-weight: bold;">
            ...
            <el-breadcrumb-item>空压机数据汇总</el-breadcrumb-item>
        </el-breadcrumb>
    </div> -->
    <div class="form">
        <el-form :inline="true" class="demo-form-inline" size="small">
            ...
            <el-form-item>
                <el-button type="primary" size="small" @click="onSubmit">查询</el-button> <el-button>最佳A3打印</el-button>
            </el-form-item>
        </el-form>
    </div>
...
export default {
    ...
    data() {
        return {
            baseUrl: 'http://172.32.12.100:9070/runqian5/reportJsp/showReport.jsp?rpx=/111/airPressure.rpx&',
            iframeUrl: "",
            start: "",
            end: "",
            date: "",
    ...
    methods: {
        makeUrl(start, end) {
            this.iframeUrl = this.baseUrl +
                'start=' + start +
                '&end=' + end;
            console.log('urllll', this.iframeUrl);
        },
