      ...
      <div class="boxnav">
        <table class="table table-kingdargen">
          ...
          <tbody>
            <tr>
              <td>1</td>
              <td @click="editValue('abanchanliang')">{{abanchanliang}}</td>
            ...
            <tr>
              <td>2</td>
              <td @click="editValue('bbanchanliang')">{{bbanchanliang}}</td>
            ...
            <tr>
              <td>3</td>
              <td @click="editValue('cbanchanliang')">{{ cbanchanliang }}</td>
            ...
            <tr>
              <td>4</td>
              <td @click="editValue('dbanchanliang')">{{ dbanchanliang }}</td>
