<template>
    <div>
        ...
        <div class="content">
            <div class="add-button">
                <el-button type="warning" @click="addComment">添加亚铁氰化钾消耗记录</el-button>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            addComment(){
                this.changeComment({})
                this.$router.push('/potassiumFerrocyanide/addpotassiumFerrocyanide')
            },
            onSubmit() {
            ...
            handleEdit(index, row) {
                ...
                this.$router.push('/potassiumFerrocyanide/editpotassiumFerrocyanide') // 虽然组件是一样的，但是这里不改的，触发不了后面edit跟add的判断了
            },
