...
<div>
    ...
    <div class="maincontrol">
        <el-table :header-cell-style="{ background: '#f2f2f2' }" border :data="tableData" size="" style="width: 99%; margin-bottom: 20px">
            ...
            <el-table-column label="碘酸钾溶液" min-width="200" :show-overflow-tooltip="false">
            ...
            <el-table-column label="备注" min-width="300" :show-overflow-tooltip="false">
                <!-- <el-table-column prop="handoverPerson" label="交班人" min-width="300" :show-overflow-tooltip="false">
                    <template slot-scope="scope">
                        <el-input type="textarea" :autosize="{ minRows: 1, maxRows: 5 }" v-model="scope.row.handoverPerson" class="input-text" @blur="blurEvent(scope.row, scope.$index)">
                        </el-input>
                    </template>
                </el-table-column> -->
                ...
                <!-- <el-table-column prop="successor" label="接班人" min-width="300" :show-overflow-tooltip="false">
                    <template slot-scope="scope">
                        <el-input type="textarea" :autosize="{ minRows: 1, maxRows: 5 }" v-model="scope.row.successor" class="input-text" @blur="blurEvent(scope.row, scope.$index)">
                        </el-input>
                    </template>
                </el-table-column> -->
            </el-table-column>
    ...
    methods: {
        ...
        deleteRow(index, rows) {
            ...
            this.$confirm('此操作将永久删除该信息, 是否继续?', '提示', {
                ...
                this.getpotassiumConsumptionList(this.start, this.end);
            });
        },
        ...
        async updatePotassiumConsumption(params) {
            let res = await this.$api.updatePotassiumConsumption(params);
            ...
            try {
                ...
                const promises = this.tableData.map(async (item) => {
                    ...
                    if (item.isNew) {
                        ...
                        return this.$api.addPotassiumConsumption({
                        ...
                        return this.$api.updatePotassiumConsumption({
                            id: item.id,
                            biaoTime: item.biaoTime,
                ...
                await this.getpotassiumConsumptionList(this.start, this.end); // 强制重新加载数据
