...
<div>
    ...
    <el-table ref="multipleTable" border stripe :data="tableData" height="658" tooltip-effect="dark" size="mini" @selection-change="selsChange" style="width: 100%; margin-top: 30px" class="custom-table">
        ...
        <el-table-column prop="waterPumpA" label="P-404A—除尘水泵电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.waterPumpA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>

        <el-table-column prop="waterPumpB" label="P-404B—除尘水泵电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.waterPumpB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="fanA" label="F-403—引风机A电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.fanA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="hotA" label="F-401—热风机A电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.hotA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="coldA" label="F-402—冷风机A电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.coldA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="hotTempA" label="热风温度（℃）" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.hotTempA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="weiTempA" label="尾气温度（℃）" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.weiTempA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="dryTempA" label="干燥床出口盐温（℃）" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.dryTempA" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        ...
        <el-table-column prop="fanB" label="F-403—引风机B电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.fanB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="hotB" label="F-401—热风机B电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.hotB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="coldB" label="F-402—冷风机B电流(A)" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.coldB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="hotTempB" label="热风温度（℃）" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.hotTempB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="weiTempB" label="尾气温度（℃）" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.weiTempB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="dryTempB" label="干燥床出口盐温（℃）" min-width="50px">
            <template slot-scope="scope">
                <el-input type="text" v-model="scope.row.dryTempB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
            </template>
        </el-table-column>
        ...
        <el-table-column label="干燥蒸汽" min-width="50px">
            <el-table-column prop="dryPressureB" label="压力（kpa）" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.dryPressureB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
                </template>
            </el-table-column>
            <el-table-column prop="deyTempB" label="温度（℃）" min-width="50px">
                <template slot-scope="scope">
                    <el-input type="text" v-model="scope.row.deyTempB" class="input" @blur="blurEvent(scope.row,scope.$index)" ></el-input>
                </template>
            </el-table-column>
        </el-table-column>
