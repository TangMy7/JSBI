<template>
    <div>
        ...
        <!-- 
                    ...
                    -->
        <div>
            <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px; margin-bottom: 15px;margin-left: 8px; color: black; font-size: 18px; font-weight: bold;">
        ...
        <el-table ref="multipleTable" border stripe :data="tableData" height="700" tooltip-effect="dark" @selection-change="selsChange" style="width: 100%; margin-top: 30px" class="custom-table">
            ...
            <el-table-column prop="username" label="账户" width="400">
                <template slot-scope="scope">
            ...
            <el-table-column prop="role" label="角色">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.role" placeholder="请选择" @blur="blurEvent(scope.row, scope.$index)">
            ...
            <el-table-column prop="post" label="职位">
                <template slot-scope="scope">
                    <el-select v-model="scope.row.post" placeholder="请选择" @blur="blurEvent(scope.row, scope.$index)">
