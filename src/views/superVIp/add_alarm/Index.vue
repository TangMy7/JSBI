    ...
    <div class="main">
        ...
        <el-form :model="formInline" label-width="auto" class="full-width-form">
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    <div class="grid-content bg-purple">
                        <el-form-item label="可能的原因(大于)" class="full-width-item">
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    <div class="grid-content bg-purple">
                        <el-form-item label="可能的原因(小于)" class="full-width-item">
                            <el-input v-model="formInline.naocan1" type="textarea" :autosize="{ minRows: 3 }"
                                class="full-width-input">
                            </el-input>
                        </el-form-item>
                    </div>
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    <div class="grid-content bg-purple">
                        <el-form-item label="解决措施（大于）" class="full-width-item">
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    <div class="grid-content bg-purple">
                        <el-form-item label="解决措施（小于）" class="full-width-item">
                            <el-input v-model="formInline.naocan2" type="textarea" :autosize="{ minRows: 3 }"
                                class="full-width-input">
                            </el-input>
                        </el-form-item>
                    </div>
        ...
        onSubmit() {
            ...
            if (this.mode == "edit") {
                ...
                this.addComment({
                    ...
                    naocan1: this.formInline.naocan1,
                    naocan2: this.formInline.naocan2,
