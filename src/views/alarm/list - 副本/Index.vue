<template>
    <div>
        ...
        <el-table ref="multipleTable" border stripe :data="tableData" height="700" tooltip-effect="dark"
            ...
            <el-table-column prop="namee" label="名字" width="130" :show-overflow-tooltip="false">
                <template slot-scope="scope">
            ...
            <el-table-column prop="PointId" label="点位" width="150" :show-overflow-tooltip="false">
                <template slot-scope="scope">
            ...
            <el-table-column prop="possibleCause" label="可能的原因" width="330" :show-overflow-tooltip="false">
                <template slot-scope="scope">
            ...
            <el-table-column prop="Solution" label="解决措施" width="560" :show-overflow-tooltip="false">
                <template slot-scope="scope">
            ...
            <el-table-column prop="normalRange" label="取值范围" width="120" :show-overflow-tooltip="false">
                <template slot-scope="scope">
                    <el-input type="textarea" :autosize="{ minRows: 1, maxRows: 5 }" v-model="scope.row.normalRange"
                        class="input-text" @blur="blurEvent(scope.row, scope.$index)">
                    </el-input>
                </template>
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        addComment() {
            this.changeComment({})
            this.$router.push('/Alarm/AddAlarm')
        },
        onSubmit() {
