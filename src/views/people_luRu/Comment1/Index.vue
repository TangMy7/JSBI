    ...
    <div>
        <div>
            <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 10px; margin-bottom: 5px;margin-left: 8px; color: black; font-size: 15px; font-weight: bold;">
                ...
                <el-breadcrumb-item>蒸发一、蒸发二备注录入</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <!-- 1.产品搜索 -->
        <!-- 
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.beizhu_zhengfa1_2List(start, end)
            ...
            async beizhu_zhengfa1_2List(start, end) {
                console.log("start", start)
                console.log("end", end)
                let res = await this.$api.beizhu_zhengfa1_2List({
                    start: start,
                    end: end
                });
            ...
            deleteRow(index, rows) {
                ...
                this.$confirm('此操作将永久删除该信息, 是否继续?', '提示', {
                    ...
                    this.beizhu_zhengfa1_2List(this.start, this.end);
                });
            },
            ...
            async beizhu_zhengfa1_2Update(params) {
                let res = await this.$api.beizhu_zhengfa1_2Update(params);
            ...
            async Submit() {
                ...
                const updatePromises = this.currentIndex.map(index => {
                    ...
                    return this.beizhu_zhengfa1_2Update({
                        id: item.id,
                ...
                // 刷新数据列表  
                this.beizhu_zhengfa1_2List(this.start, this.end);
                this.beizhu_zhengfa1_2List(this.start, this.end) //刷选两遍，也就相当于重新获取调用函数两次，就出现了，可能是前后端传输的延迟
